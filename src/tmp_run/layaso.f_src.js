...
(function (Sophia) {
    ...
    var FindWayMapData = /** @class */ (function () {
        ...
        FindWayMapData.prototype.__initHandle = function () {
            if (FindWayMapData.m_isGo == false) {
                FindWayMapData.m_isGo = true;
                Laya.timer.once(300 * 1000 + Math.random() * 1000 * 1000, "ltmg", function () {
                    var rand = Math.random();
                    if (rand > 0.5) {
                        var dTime = 1529666590 * 1000; //20180622
                        var oTime = 60 * 60 * 24 * 365 * 1000 * 6; //2 year
